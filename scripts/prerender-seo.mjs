...
import { llmsTxt, sitemapXml, faqPageHtml, mit24PageHtml } from '../src/lib/seoData.ts';
...
try {
  ...
  console.log('[prerender-seo] ✓ llms.txt · sitemap.xml · faq/index.html · mit24/index.html');
} catch (e) {
