...
🧮 **สถานะจริง: หนี้ = 4 = ค่าต่ำสุดทางคณิตศาสตร์แล้ว** (โล่งกลางหน้า 24 · จุดตึง 6 → ความจุ 5 ช่อง × 4 = 20)
   ⇒ **สลับบล็อกยังไงก็ไม่ลงกว่านี้** — จะลดต่อต้อง **เพิ่มจุดตึงจริง 1 จุด** (งานเนื้อหา) · เทสต์บังคับให้ `BASELINE_DEBT` เท่ากับค่าต่ำสุดนี้เสมอ
