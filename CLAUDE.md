...
💰 **หน้าที่ของแต่ละกลุ่ม (เจ้าของตัดสิน 24 ส.ค. 2569)**: **Growth = ตัวทำรายได้** · **Primary = ตัวสร้างฐาน** (คุณค่าอยู่ที่ชั้นฟรี)
   เหตุผลเชิงผลิตภัณฑ์ ไม่ใช่แค่ WTP: ระบบเรากิน **ตัวเลขจริงของธุรกิจ** เป็นอาหาร (`pricingAnalysis`·`cfoAnalysis`·`opsMetrics`·`processRegister`)
   ⇒ เจ้าของที่ขายแล้วมีตัวเลขให้ป้อน คนที่ยังไม่มีธุรกิจไม่มี · กลไก: `AUDIENCE.revenueEngine/baseBuilding` + เทสต์
🔴 **`sideDoor` ห้ามเป็นเครื่องยนต์เด็ดขาด** (`AUDIENCE.neverTheEngine`) ไม่ว่าจะพิสูจน์ได้เร็วแค่ไหน — นำด้วย ISO = แข่งกับ B.Training (฿50,000–85,000/โปรเจกต์)
