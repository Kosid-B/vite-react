...
src/lib/founderMindset.ts      — ด่านความพร้อม 6 ข้อก่อนเร่งเครื่อง (Founder Mindset Engine) · อ่านจากข้อมูลจริงใน AppData ห้ามให้ติ๊กเอง · เตือน ไม่ใช่ห้าม (scaleCheck ไม่เคยคืนคำสั่งห้าม) · ทุกด่านต้องพาไปหน้าที่แพ็กฟรีเข้าได้ (มีเทสต์บังคับ) · ภาษาต้องไม่มีศัพท์ ARPU/LTV/CAC/MRR/persona/funnel (มีเทสต์บังคับ) · แสดงผลที่ components/FounderReadiness.tsx บนสุดของห้องบอร์ด · กติกาเต็ม: docs/strategy/FOUNDER-CONSTITUTION.md
