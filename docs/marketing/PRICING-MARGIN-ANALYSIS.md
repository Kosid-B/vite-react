...
2. **เพิ่ม billing รายปี (2 เดือนฟรี = ลด 16.7%)** — anchor ราคา + เงินสดล่วงหน้า + ลูกค้า commit เร็วขึ้น (Starter ฿7,900/ปี · Growth ฿14,900/ปี · Scale ฿59,000/ปี) → *value-prop lever อันดับ 1*
