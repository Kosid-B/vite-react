...
| *(ราคาปาล์มตก)* | `ceoaithailand.org/palm` | สิ่งที่คุมได้ / คุมไม่ได้ · ต้นทุนต่อไร่ |
...
### 💰 ตั้งราคาไม่ขาดทุน 🔥 *(คลิป "จานละ 50 บาท" ทำ 14.5K — ชุดเต็ม: [READY-TO-POST-PRICING-50BAHT.md](READY-TO-POST-PRICING-50BAHT.md))*
```
ชุด "จานละ 50"  https://ceoaithailand.org/price?s=fb&c=plate
...
### 🌴 ราคาปาล์มตก — สิ่งที่คุมได้ *(มีคลิปที่ได้ 781 วิวอยู่แล้ว)*
```
...
## 📅 ปฏิทินสลับไบโอ — เปลี่ยนเดือนละ 2 ครั้ง ไม่ใช่วันละครั้ง

**ทำไม:** TikTok/Instagram มีลิงก์ไบโอได้ทีละอัน และอัลกอริทึมดันคลิปเก่าขึ้นมาใหม่ได้เสมอ
ถ้าสลับไบโอตามคลิปที่เพิ่งโพสต์ คนที่ดูคลิปเก่าวันนี้จะกดไปเจอเรื่องที่ไม่เกี่ยว = เสียไปทั้งหมด

**วิธีแก้:** ล็อกหนึ่งเรื่องต่อหนึ่งช่วง โพสต์เรื่องนั้นรวดทั้งช่วง แล้วค่อยสลับ

| ช่วง | เรื่องที่โพสต์ | ไบโอ TikTok | ไบโอ Instagram |
|---|---|---|---|
| **14 ส.ค.–31 ส.ค. 69** | 💰 **ต้นทุน/ตั้งราคา** 🔥 *คลิป "จานละ 50" ทำ 14.5K* | `https://ceoaithailand.org/price?s=tt` | `…/price?s=ig` |
| 1–14 ก.ย. | SMS ปลอม *(ถ้ายังทัน)* หรือ ราคาปาล์ม | `…/palm?s=tt` | `…/palm?s=ig` |
...
| 27 ต.ค.–9 พ.ย. | ไม่ต้องเก่ง AI | `…/ai?s=tt` | `…/ai?s=ig` |

> ### ⚠️ ทำไม "ต้นทุน/ตั้งราคา" แซงขึ้นมาเป็นช่วงแรก
>
> คลิป Facebook Reels **"จานละ 50 บาท กำไร 20 ใช่ไหม?"** ทำ **14,500 วิวใน 46 ชม.**
> บนเพจที่มีผู้ติดตามหลักสิบ = เรื่องเดียวที่มีหลักฐานว่าอัลกอริทึมยอมดันและคนหยุดดู
>
> **กฎ "โพสต์เป็นช่วง" มีไว้ให้ไบโอตรงกับสิ่งที่คนดูเพิ่งดู** — นั่นคือ*เหตุผล*ของกฎ ไม่ใช่ตัวปฏิทิน
> ทราฟฟิกอยู่ที่เรื่องต้นทุน ไบโอจึงต้องอยู่ที่นั่น
>
> คลิปนี้แมปกับ `/price` → `/blog/pricing-no-loss` (ตั้งราคาไม่ขาดทุน) พอดี ไม่ต้องเขียนบทความใหม่
>
> 🔴 **ทำก่อนอย่างอื่น:** ปักหมุดคอมเมนต์ในคลิป "จานละ 50 บาท" ด้วย `ceoaithailand.org/price`
> — บน Facebook Reels คอมเมนต์แรกคือทางหลัก เพราะลิงก์ในโพสต์ทำให้ reach ตกหนัก

### ข้อความไบโอต้องเปลี่ยนพร้อมลิงก์ทุกครั้ง

ถ้าเปลี่ยนแต่ลิงก์ ข้อความจะบอกเรื่องหนึ่งแต่ลิงก์พาไปอีกเรื่อง — คนอ่านแล้วสับสน ไม่กด

```
บรรทัด 1 (คงที่)  สร้างธุรกิจและวางระบบด้วยตัวคนเดียว ด้วยทีม AI
บรรทัด 2 (เปลี่ยน) ← ตามช่วง ดูด้านล่าง
```

| ช่วง | บรรทัดที่ 2 |
|---|---|
| **ต้นทุน/ตั้งราคา** ← ใช้ตอนนี้ | `จานละ 50 กำไรจริงเท่าไร คิดให้ดู อ่านฟรี 👇` |
| ราคาปาล์ม | `ราคาตก ต้นทุนเท่าไรถึงไม่ขาดทุน อ่านฟรี 👇` |
| SMS ปลอม | `เช็ก SMS ปลอม อ่านฟรี ไม่ต้องสมัคร 👇` |
| ต้นทุน/ราคา | `ตั้งราคายังไงไม่ขาดทุน อ่านฟรี 👇` |
| หาลูกค้า | `หาลูกค้า 10 คนแรกโดยไม่ยิงแอด 👇` |
| ไม่มีทุน | `เริ่มธุรกิจไม่มีทุน 7 ก้าว อ่านฟรี 👇` |
| แผนธุรกิจ | `ทำแผนธุรกิจเสร็จใน 1 ชม. อ่านฟรี 👇` |
| ไม่ต้องเก่ง AI | `ลองใช้ทีม AI ฟรี ไม่ต้องสมัคร 👇` |

### ✅ Checklist วันสลับช่วง (~5 นาที)

- [ ] TikTok — ✏️ → **ลิงก์** → เปลี่ยน URL (`?s=tt`)
- [ ] TikTok — ✏️ → **ประวัติ** → เปลี่ยนบรรทัดที่ 2
- [ ] Instagram — แก้ไขโปรไฟล์ → **เว็บไซต์** (`?s=ig`)
- [ ] Instagram — แก้ข้อความไบโอบรรทัดที่ 2
- [ ] เปิดจากมือถือจริง กดลิงก์ 1 ครั้ง → เข้าถูกหน้า
- [ ] **คลิปเด่นของช่วงที่ผ่านมา** — ปักหมุดคอมเมนต์ที่มี URL เดิม
      (คอมเมนต์ผูกกับคลิป ไม่ถูกสลับตามไบโอ = ยังกู้คนจากคลิปเก่าได้)

> **Facebook / YouTube / LINE ไม่ต้องแตะเลย** — ลิงก์ผูกกับโพสต์แต่ละอันอยู่แล้ว
> โพสต์เรื่องไหนใส่ลิงก์เรื่องนั้นตอนโพสต์ จบในตัว
...
**ก่อนโพสต์:**
1. โปรไฟล์ → **✏️ มุมซ้ายบน** (แก้ไขโปรไฟล์) → **ลิงก์** → ช่อง **URL**
2. ใส่ `https://ceoaithailand.org/sms?s=tt` (ตามช่วงในปฏิทินด้านบน)
3. ครบช่วงแล้วสลับตามตาราง — **ไม่ใช่สลับตามคลิป**

**ข้อควรรู้ TikTok (จากหน้างานจริง):**
- ต้องเป็น **บัญชีธุรกิจ** ช่อง "ลิงก์" ถึงจะโผล่ (เปลี่ยนฟรี · ☰ → การตั้งค่า → บัญชี)
- URL ที่**พิมพ์ในข้อความไบโอกดไม่ได้** — ที่กดได้คือบรรทัดตัวหนาที่ TikTok สร้างให้เท่านั้น
  (อย่าพิมพ์ URL ซ้ำในไบโอ จะขึ้น 2 บรรทัดเหมือนกันจนคนกดผิด)
- เมนู **"ปุ่มดำเนินการ"** ใส่ลิงก์เว็บ**ไม่ได้** — มีแค่ อีเมล/โทร/ที่อยู่/แอป
  (ช่อง "แอป" ไว้ใส่ลิงก์ App Store เท่านั้น อย่าเอา URL เว็บไปใส่)
  → ใส่ **อีเมล** แทน จะได้ปุ่มติดต่อจริงบนโปรไฟล์ สำหรับคนที่อยากคุยงาน
- **ปุ่มลิงก์บนตัวคลิป** ได้จาก **โปรโมท (เสียเงิน)** เท่านั้น และต้องเลือกเป้าหมาย
  **"การเข้าชมเว็บไซต์เพิ่มขึ้น"** — ถ้าเลือก "เพิ่มผู้ติดตาม" จะไม่มีปุ่มลิงก์เลย
- แก้แคปชันย้อนหลังอาจทำไม่ได้ → **ปักหมุดคอมเมนต์**แทน · **ห้ามลบคลิปแล้วโพสต์ใหม่**
  (วิว/คอมเมนต์/งบโฆษณาหายหมด)
...
### 🚪 คนดูถึงวินาทีที่มี CTA หรือเปล่า — คำนวณก่อนโทษ CTA

**วัดจากคลิป "จานละ 50 บาท กำไร 20 ใช่ไหม?" (FB Reels · 12 ส.ค. 69)**

| ตัวเลข | ค่า | อ่านว่า |
|---|---|---|
| ยอดวิว | 14,500 | ✅ อัลกอริทึมดันเต็มที่ |
| ความยาว | 15.02 วิ | |
| **เวลาดูเฉลี่ย** | **4.3 วิ (29%)** | 🔴 คนออกกลางคลิป |
| **ดูจนจบ** | **4.67%** | 🔴 คนเห็น CTA จริง ~677 คน |
| เข้าโปรไฟล์ | 11 | = **1.6% ของคนที่ดูจนจบ** → ปกติ |

**บทเรียน: อย่าหาร conversion ด้วยยอดวิวดิบ**
11 ÷ 14,500 = 0.08% ดูเหมือนหายนะ · 11 ÷ 677 = 1.6% คือปกติ
**ตัวเลขเดียวกัน คนละข้อสรุป และนำไปแก้คนละจุด**

**จุดที่ต้องแก้จริงคือวินาทีที่ 2–5 ไม่ใช่ CTA**
- ตัดคลิป 15 วิ → **8 วิ** = คนกลุ่มเดิม "ดูจนจบ" ทันที = คนเห็น CTA เพิ่มหลายเท่า
  โดยไม่ต้องหา reach เพิ่มเลย
- โครงที่ใช้: **เฉลยเลย → ขยาย → CTA** ไม่ใช่ เกริ่น → อธิบาย → เฉลย → CTA

**และยังต้องสั่งให้ชัดอยู่ดี** — พูด + ขึ้นจอ 2 วินาทีสุดท้าย:
```
กดชื่อผมด้านบน → ลิงก์อยู่ในโปรไฟล์
ceoaithailand.org/price
```

### 🔧 วิธีทำจริงบนมือถือ — ปักหมุดคอมเมนต์ / เปลี่ยนชื่อเพจ

#### ปักหมุดคอมเมนต์ Facebook (2 นาที)

> ⚠️ **ต้องคอมเมนต์ในนามเพจ ไม่ใช่โปรไฟล์ส่วนตัว** — สาเหตุอันดับ 1 ที่หาปุ่มปักหมุดไม่เจอ

1. สลับโปรไฟล์เป็น **เพจ** (กดรูปโปรไฟล์มุมขวาบน → เลือกเพจ)
2. เปิดคลิป → กดไอคอน 💬 → พิมพ์ข้อความ → ส่ง
3. **กดค้างที่ตัวหนังสือคอมเมนต์ตัวเอง ~2 วินาที** → เมนูเลื่อนขึ้นจากด้านล่าง
4. เลือก **"ปักหมุดความคิดเห็น"** (Pin comment)

| ปัญหา | แก้ |
|---|---|
| ไม่มีปุ่มปักหมุด | ยังอยู่ในโปรไฟล์ส่วนตัว → สลับเป็นเพจ · หรือไม่ได้เป็นแอดมิน |
| กดค้างไม่ติด | กดจุดสามจุด **⋯** ข้างคอมเมนต์แทน |
| ปักอันใหม่แล้วอันเก่าหาย | ปกติ — ปักได้ทีละ 1 คอมเมนต์ต่อโพสต์ |

#### เปลี่ยนชื่อเพจ Facebook — 🔴 **ได้ครั้งเดียวต่อ 60 วัน**

1. สลับเป็นโปรไฟล์เพจ → กดรูปโปรไฟล์ **มุมขวาบน** → ⚙️ **ตั้งค่า**
2. **"การตั้งค่าเพจ"** (Page setup) → **"ชื่อ"** (Name)
3. แก้ชื่อ → **"ตรวจสอบการเปลี่ยนแปลง"** (Review Change)
4. รออนุมัติ — ปกติไม่กี่ชั่วโมงถึง 3 วัน · ชื่อที่ใกล้เคียงของเดิมผ่านง่าย

> 🔴 **ห้ามแก้แค่ typo แล้วกดส่ง** — โควตาจะหมดไปทั้งรอบ 60 วัน
> คิดชื่อสุดท้ายที่ต้องการให้จบก่อน แล้วเปลี่ยนทีเดียว
>
> **หลักการตั้งชื่อ:** ต้องมีคำที่*กลุ่มคลิปที่ปังเข้าใจ* + คำที่*ลูกค้าที่จ่ายเงินใช้ค้นหา*
> ตัดคำเฉพาะทางที่คนนอกวงการไม่รู้จักออก และอย่าให้ยาวจนถูกตัดท้ายบนมือถือ

---

### 📉 Facebook: โพสต์ที่มีลิงก์ = reach ตกหนัก

| โพสต์เดียวกันช่วงเดียวกัน | ยอดวิว |
|---|---|
| Reels "จานละ 50 บาท" | **14,500** |
| โพสต์ลิงก์บทความ | **0** |

แดชบอร์ดของ Facebook เองยังขึ้นว่า Reels ได้วิวมากกว่าโพสต์ข้อความ ~338–375%

> **กฎ: เนื้อหาไปทางคลิป · ลิงก์ไปทางคอมเมนต์แรก**
> ห้ามวางลิงก์ในโพสต์หลักเพื่อหวัง reach — ได้ลิงก์ที่กดได้ แต่ไม่มีใครเห็นโพสต์
