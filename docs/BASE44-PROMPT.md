...
- Free (฿0) → Starter (฿790/เดือน) → Growth (฿1,490/เดือน) → Scale (฿5,900/เดือน)
...
```
หน้า "แพ็กเกจ & ชำระเงิน": แสดง 4 แพ็ก (Free/Starter ฿790/Growth ฿1,490/Scale ฿5,900)
...
PLANS: Free ฿0 → Starter ฿790/mo → Growth ฿1,490/mo → Scale ฿5,900/mo. New users get a free 15-day
