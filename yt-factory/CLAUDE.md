...
⚠️ **ข้อสรุปนี้ขึ้นกับว่าขายหรือใช้เอง**
- **ใช้เองในบริษัท (ตอนนี้)**: CapCut draft ใช้ได้ดี มีคนอยู่ในลูปอยู่แล้ว วันละ 5–6 คลิปกดไหว
  คลิปสวยกว่าและแก้เองได้ ไม่ต้องมานั่งจูน ffmpeg ให้ซับไทยออกมาสวย
- **ถ้าเปิดขายวันหนึ่ง**: ต้องมี ffmpeg เป็นทางหลัก เพราะลูกค้าไม่ยอมนั่งกด export เอง
  และ CapCut ก็รับโหลดหลายรายพร้อมกันไม่ได้
...
- ffmpeg backend — จำเป็นเมื่อลูกค้านอกใช้ ตอนนี้ CapCut draft พอ
