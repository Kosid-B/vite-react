...
export const SKILL_CATALOG: SkillEntry[] = [
  ...
  },
  {
    ...
    category: 'strategy', tier: 3, price: 2000, icon: '🐜',
    desc: 'นิยามอัตลักษณ์องค์กร (เราคือใคร/จะไปไหน/ชนะยังไง) · แยกแก่น "ปฏิบัติการ" vs "อัตลักษณ์" เป็นเข็มทิศ + เตรียมภูมิคุ้มกันวิกฤต (สภาพคล่อง/สำรอง/ผันตัว) แบบอภิสิ่งมีชีวิตแมลง',
    official: true,
    tags: ['CEO', 'Founder', 'COO'],
    valueNote: 'ป้องกัน "หลงแก่น" แบบ Kodak (ยึดฟิล์มแทนความทรงจำ) · แก่นอัตลักษณ์ชัด = เข็มทิศข้ามทุกวิกฤต',
  },
  {
    id: 'positioning-specialization',
    name: 'Positioning & Specialization (UVP + ป้อมปราการเฉพาะทาง)',
    category: 'strategy', tier: 3, price: 2000, icon: '🦋',
    desc: 'สร้าง UVP โดดเด่นต่างจากคู่แข่ง (Relevancy/Value/Differentiation) + เลือกความเชี่ยวชาญหลัก 1 อย่าง (tech/service/cost) แล้วพัฒนา value chain ให้ลอกเลียนยาก',
    official: true,
    tags: ['CEO', 'Marketing Manager', 'COO', 'Product Manager'],
    valueNote: 'จุดขายที่ลอกยาก = ป้อมปราการระยะยาว · เทียบ workshop positioning/strategy ฿20,000+',
  },
  {
