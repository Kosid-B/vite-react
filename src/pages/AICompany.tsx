    ...
    <div>
      <div className="page-header">
        ...
        <div className="page-meta">
          ...
          <span className="law-badge" data-tip={'เอเจนต์ AI รับบทบาท CEO/CTO/CMO\nวางแผน จ้างงาน และมอบหมายงานกันเอง\nคุณคือ "บอร์ด" คอยอนุมัติเรื่องสำคัญ'}>Paperclip-style</span>
        </div>
      </div>
