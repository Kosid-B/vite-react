...
export type LegalSection = 'company' | 'privacy' | 'cookies' | 'refund' | 'terms';
    ...
    <div className="legal-root">
      ...
      <section id="privacy" className="legal-sec">
        ...
        <ul>
          ...
          <li><b>ข้อมูลแผนธุรกิจจากพันธมิตร:</b> หากคุณเลือกส่งแผนธุรกิจของคุณจากแพลตฟอร์มพันธมิตร (เช่น theossphere) มายังบริการของเรา เราจะรับเฉพาะ<u>แผนธุรกิจที่คุณกดส่งเอง</u>เพื่อเตรียมพร้อมให้ทีม AI ทำงานต่อ</li>
        </ul>
        ...
        <p><b>การรับข้อมูลจากแพลตฟอร์มพันธมิตร (Context Handoff):</b> หากคุณเลือกส่งแผนธุรกิจของคุณจากแพลตฟอร์มพันธมิตร (เช่น theossphere) มายังบริการนี้ เราจะรับข้อมูล<u>บนฐานความยินยอมของคุณเท่านั้น</u> (คุณเป็นผู้กดส่งเอง) เพื่อนำแผนมาเตรียมพร้อมให้ทีม AI ทำงานต่อ เราเก็บเฉพาะข้อมูลแผนธุรกิจที่จำเป็น และคุณสามารถ<b>ถอนความยินยอม/ลบข้อมูล</b>ได้ทุกเมื่อโดยลบเวิร์กสเปซในระบบ หรือติดต่อ <a href={`mailto:${SUPPORT_EMAIL}`}>{SUPPORT_EMAIL}</a></p>
      ...
      {/* ============ 3. นโยบายคุกกี้ ============ */}
      <section id="cookies" className="legal-sec">
        <h2>3. นโยบายคุกกี้ (Cookie Policy)</h2>
        <p>เว็บไซต์นี้ใช้คุกกี้และเทคโนโลยีจัดเก็บข้อมูลบนอุปกรณ์ของคุณ (เช่น localStorage) เพื่อให้บริการทำงานได้และเข้าใจการใช้งานเพื่อพัฒนาระบบ</p>

        <h3>3.1 ประเภทของคุกกี้ที่เราใช้</h3>
        <table className="legal-table">
          <thead>
            <tr><th>ประเภท</th><td><b>รายละเอียด</b></td></tr>
          </thead>
          <tbody>
            <tr>
              <th>จำเป็น (Necessary)</th>
              <td>ทำให้ระบบทำงานได้ เช่น การเข้าสู่ระบบ/เซสชัน (Supabase Auth), การจดจำว่าเคยเห็นหน้าแนะนำแล้ว และการเก็บข้อมูลเวิร์กสเปซของคุณไว้ในเครื่อง (localStorage) — <b>ปิดไม่ได้</b> เพราะจำเป็นต่อการใช้งาน</td>
            </tr>
            <tr>
              <th>วิเคราะห์ (Analytics)</th>
              <td>Google Analytics 4 เพื่อเข้าใจภาพรวมการใช้งานและปรับปรุงบริการ — <b>ทำงานเมื่อคุณยินยอมเท่านั้น</b> (ผ่านแถบความยินยอมด้านล่างหน้าจอ)</td>
            </tr>
            <tr>
              <th>วัดประสบการณ์ (Pulse)</th>
              <td>ฟีเจอร์ Pulse &amp; A/B เก็บความรู้สึกแบบไม่ระบุตัวตน — <b>สมัครใจ (opt-in)</b> ค่าเริ่มต้นปิด เปิด/ปิด/ลบได้ในหน้า Pulse</td>
            </tr>
          </tbody>
        </table>

        <h3>3.2 การจัดการความยินยอม</h3>
        <p>เมื่อเข้าเว็บไซต์ครั้งแรก จะมีแถบให้เลือก “ยอมรับทั้งหมด” หรือ “เฉพาะที่จำเป็น” หากเลือกเฉพาะที่จำเป็น เราจะ<b>ไม่เปิดใช้การวิเคราะห์</b> คุณเปลี่ยนใจได้โดยล้างข้อมูลเบราว์เซอร์แล้วเลือกใหม่</p>

        <h3>3.3 การควบคุมจากฝั่งคุณ</h3>
        <ul>
          <li>ตั้งค่า/ลบคุกกี้ได้จากเบราว์เซอร์ของคุณ (การปิดคุกกี้จำเป็นอาจทำให้ใช้งานบางส่วนไม่ได้)</li>
          <li>ปฏิเสธ Google Analytics เพิ่มเติมได้ที่ <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noreferrer">tools.google.com/dlpage/gaoptout</a></li>
        </ul>
      </section>
      ...
      <section id="refund" className="legal-sec">
        ...
        <h3>4.4 วิธีขอคืนเงินและระยะเวลา</h3>
      ...
      <section id="terms" className="legal-sec">
        <h2>5. ข้อกำหนดและเงื่อนไขการใช้บริการ (Terms &amp; Conditions)</h2>

        <h3>5.1 การยอมรับข้อตกลง</h3>
        <p>การเข้าถึงหรือใช้บริการ {BRAND.product} ถือว่าคุณยอมรับข้อกำหนดฉบับนี้ หากไม่ยอมรับ โปรดหยุดใช้บริการ</p>

        <h3>5.2 คุณสมบัติและบัญชีผู้ใช้</h3>
        ...
        <h3>5.3 การใช้งานที่ยอมรับได้</h3>
        ...
        <h3>5.5 คำแนะนำจาก AI (ข้อจำกัด)</h3>
