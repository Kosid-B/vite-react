 ...
 * เป้าหมาย: สมัครฟรี → สร้างหน้าร้าน → มีรายได้จาก RFQ → อัปเกรด Starter ฿790 */
...
const FAQS: FaqItem[] = [
  ...
  { q: 'ต้องจ่ายเมื่อไหร่ ค่าใช้จ่ายเท่าไหร่?', a: 'เริ่มฟรี ฿0. อัปเกรด Starter ฿790/เดือนเมื่อพร้อมรับงานผ่าน RFQ (ถูกกว่าจ้างผู้ช่วย 1 คนหลายสิบเท่า) และระบบคิดค่าดำเนินการเพียง 3% เมื่อคุณปิดดีลได้จริงเท่านั้น — เราโตเมื่อคุณมีรายได้' },
