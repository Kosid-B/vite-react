...
export function calcPageHtml(origin: string, search: string): string {
  ...
  /* 🔴 พาดหัวต้องขึ้นต้นด้วย "คำที่คนพิมพ์ค้นหา" ไม่ใช่คำชวนคุย (แก้ 22 ส.ค. 2569)
   *   ของเดิม 'คิดให้ดูเลย — ขายราคานี้ กำไรหรือขาดทุน' มีคำว่าต้นทุน/กำไรอยู่ก็จริง
   *   แต่ถูกดันไปท้ายประโยค · ทั้ง Google และคนสแกนผลค้นหาให้น้ำหนักคำต้น ๆ มากกว่า
   *   ⇒ ไม่มีใครพิมพ์ค้นว่า "คิดให้ดูเลย" แต่มีคนพิมพ์ "คำนวณต้นทุน" · "กำไรต่อชิ้น" · "จุดคุ้มทุน" ทุกวัน */
  const title = 'คำนวณต้นทุนและกำไรต่อชิ้น — ขายราคานี้ กำไรหรือขาดทุน (ฟรี)';
