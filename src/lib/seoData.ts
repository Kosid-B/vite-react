...
- [เปิดร้านออนไลน์ฟรี (สำหรับคนขาย)](${origin}/sell): วิธีเปิดร้านขายสินค้า/บริการฟรีบนตลาดธุรกิจไทย ไม่มีค่ารายเดือน ${feeHeadlineTh()} ทุกร้านได้ SEO อัตโนมัติ
...
export const CLIENT_SEO_PAGES: Record<string, { title: string; description: string }> = {
  ...
  '/sale': {
    title: 'แพ็กเกจและราคา — เริ่มต้นเท่าไร ใช้ได้ถึงไหน | CEO AI Thailand',
    description:
...
const SELL_BENEFITS = [
  { h: '🆓 เริ่มฟรี ไม่มีค่ารายเดือน', p: `แพ็กฟรีลงขายได้ 3 สินค้า ขึ้นสารบัญตลาดทันที — ${feeHeadlineTh('full')}` },
...
const SELL_FAQ = [
  { q: 'เปิดร้านบน CEO AI Thailand ฟรีจริงไหม?', a: `ฟรีจริง — แพ็กฟรีลงขายได้ 3 สินค้า ขึ้นสารบัญตลาด ไม่มีค่ารายเดือน · ${feeHeadlineTh('full')} เหมาะกับคนที่อยากทดลองตลาดก่อนลงทุน` },
...
export function sellArticleJsonLd(origin: string): object {
  return {
    ...
    description: `วิธีเปิดร้านขายสินค้า/บริการฟรีบนตลาดธุรกิจไทย CEO AI Thailand — ไม่มีค่ารายเดือน ${feeHeadlineTh()} และทุกร้านได้หน้าร้านที่ระบบทำ SEO ให้ Google เก็บเองอัตโนมัติ`,
    inLanguage: 'th',
...
export function sellPageHtml(origin: string): string {
  ...
  const desc = `เปิดร้านขายสินค้า/บริการฟรีบนตลาดธุรกิจไทย CEO AI Thailand — ลงขายได้เลยไม่มีค่ารายเดือน ${feeHeadlineTh()} และทุกร้านได้หน้าร้านที่ระบบทำ SEO ให้ Google เก็บเองอัตโนมัติ`;
  ...
  const planRows = [
    ['ฟรี', '฿0 ตลอดชีพ', `ลงขาย 3 สินค้า · ขึ้นสารบัญตลาด · ${feeHeadlineTh()}`],
