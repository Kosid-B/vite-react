...
> ระบบสร้างธุรกิจด้วย AI (AI Business Building System) ของไทย — ช่วยผู้ประกอบการ "สร้างธุรกิจตั้งแต่ต้นน้ำให้แข็งแรง แล้ววางระบบให้พร้อมเติบโต": ค้นหากลุ่มลูกค้าที่ใช่, เข้าใจปัญหาที่ลูกค้ายอมจ่าย, ทดสอบ Product–Market Fit, เปิดหน้าร้านขายจริง, ไปจนถึงวาง SOP/KPI/ระบบบริหารเพื่อขยายขนาด สำหรับ SME และผู้เริ่มต้นชาวไทย
...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  { q: 'CEO AI Thailand คืออะไร?', a: 'ระบบสร้างธุรกิจด้วย AI (AI Business Building System) ของไทย ที่ช่วยสร้างธุรกิจตั้งแต่ต้นน้ำ — หากลุ่มลูกค้าที่ใช่ ทดสอบตลาด เปิดหน้าร้านขายจริง ไปจนถึงวางระบบ SOP/KPI ให้พร้อมเติบโต โดยประยุกต์แนวทาง 24 Steps ของ MIT เข้ากับประสบการณ์ระบบบริหาร/ISO 20+ ปี' },
