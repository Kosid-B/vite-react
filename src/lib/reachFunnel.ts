 ...
 *   นี่คือ 0.07%
 *   ⚠️ แก้ 23 ส.ค. 2569: เดิมบรรทัดนี้เขียนต่อว่า "ไม่ได้เกิดจากคอนเทนต์ไม่ดี — คนดูจบ 89% ด้วยซ้ำ"
 *   **เลิกใช้ 89% เป็นหลักฐาน** — เวลารับชมรวม 6.3 ชม. ÷ 4,600 วิว = 4.9 วินาที/วิว ⇒ เป็น Shorts ≤27 วิ
 *   "ดูจบ 89%" = ดูจบคลิป 20 วินาที (Shorts เล่นเองในฟีด) ไม่ใช่สัญญาณว่าเนื้อหาโดน
 *   ⇒ เพดานไบโอยังจริงและยังเป็นคอขวด แต่ **ห้ามสรุปว่าคอนเทนต์ดีแล้ว** — ยังไม่มีหลักฐานทั้งสองทาง
 *   แหล่ง: docs/marketing/PLATFORM-REACH-2026-08-23.md
