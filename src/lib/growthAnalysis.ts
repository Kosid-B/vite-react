...
export const SECTION_LABEL: Record<string, string> = {
  ...
  market_sizer: 'เครื่องมือประเมินตลาด',
  instant_preview: 'พรีวิวผลทันที',
  lead_capture: 'เก็บอีเมลคนสนใจ',
  value_compare: 'เทียบ ทำเอง/จ้างคน/ระบบ',
  value_timeline: 'เส้นทางเห็นผล วัน 1/3/7/15',
  why_trust_ai: 'คลายความกลัว AI',
  persona_banner: 'แถบปรับตามพฤติกรรม',
  community: 'ชวนเข้าคอมมูนิตี้',
  trust_bar: 'แถบความน่าเชื่อถือ',
  how_30s: 'อธิบายระบบใน 30 วิ',
  gain_points: 'สิ่งที่คุณจะได้',
  market_demand: 'ดีมานด์ในตลาดจริง',
  pricing_calc: 'เครื่องคำนวณราคา',
  roi_calc: 'เครื่องคำนวณ ROI',
