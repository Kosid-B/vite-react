...
export const ISO_CLAUSE_GUIDE: Record<string, ClauseGuide> = {
  ...
  '5.3': { action: 'กำหนดบทบาท/หน้าที่/อำนาจ ในระบบคุณภาพ', keyDoc: 'ผังองค์กร + ใบกำหนดหน้าที่งาน (JD)', priority: 2 },
  ...
  '9.2': { action: 'ทำ Internal Audit ตามแผน + รายงานผล', keyDoc: 'แผนตรวจติดตามภายใน + รายงานตรวจติดตามภายใน', priority: 1, mandatoryDoc: true },
