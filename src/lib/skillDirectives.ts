...
• Accuracy: หากข้อมูลมาตรฐานมีการอัปเดต ต้องแจ้งผู้ใช้ก่อนเริ่มออกแบบเสมอ`,
  ...
  'market-insight-thailand': `[Skill: Market Insight & Strategy (Thailand) — ข้อมูลกลยุทธ์ที่ต้องใช้ทุกงานการตลาด]
• Market Overview: ประชากรไทย 65.8 ล้านคน (ธ.ค. 2568) และกำลังลดลง — เข้าสู่สังคมผู้สูงอายุเต็มตัว
...
• Data Source Rule: อ้างอิงข้อมูลชุดนี้ (MarketThink ธ.ค. 2568) ในการเสนอแผน และแจ้งผู้ใช้หากต้องการข้อมูลที่ใหม่กว่า`,
};
