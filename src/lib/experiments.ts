...
export const EXPERIMENTS: Experiment[] = [
  ...
  {
    id: 'value_frame',
    question: 'อะไรทำให้คุณอยาก “เริ่มลงทุนกับแพ็กเกจ” เร็วขึ้น — เห็นผลลัพธ์/ROI ที่ได้ หรือ เริ่มง่ายจ่ายเบา?',
    variants: [
      {
        id: 'roi',
        label: 'A · เห็นผลลัพธ์ที่ได้',
        headline: '฿790/เดือน = ทีม AI ทำงานแทนคุณทั้งเดือน',
        body: 'ลดความเสี่ยงเริ่มธุรกิจ + ได้ระบบ (SOP/KPI) ที่พร้อมขยาย — คุ้มกว่าจ้างคนเพิ่ม 1 ตำแหน่ง',
        cta: 'ดูว่าคุ้มแค่ไหน',
      },
      {
        id: 'easy',
        label: 'B · เริ่มง่าย จ่ายเบา',
        headline: 'เริ่มที่ ฿790/เดือน ยกเลิกได้ทุกเมื่อ',
        body: 'ไม่ต้องผูกมัดยาว ลองใช้ก่อน จ่ายเมื่อธุรกิจเริ่มมีรายได้ — หรือประหยัด 2 เดือนถ้าจ่ายรายปี',
