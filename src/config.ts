...
export const BRAND = {
  ...
  /* 🔴 ห้ามกลับไปใช้ "แพลตฟอร์มสร้างบริษัท AI อัตโนมัติ" / "จ้าง AI เป็นทีมงาน"
   *    = สารเก่าที่ยกเลิกแล้ว (brandEntity หัวไฟล์ · เทสต์ supersededMessage เฝ้าอยู่) */
  tagline: 'ระบบสร้างและเดินธุรกิจด้วย AI สำหรับ SME ไทย',
};
