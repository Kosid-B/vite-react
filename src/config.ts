...
/* ธีมมินิมอล (สว่าง) — ยังไม่เสร็จสำหรับ "หน้าในแอป"
 *
 * 🔴 วัดจริง 22 ส.ค. 2569 ด้วย `node scripts/contrast-audit.mjs 4.5` (เดินครบ 50 หน้า):
 *    ธีมสว่างมีข้อความที่ contrast < 2.0 (มองไม่เห็นเลย) **41 จุด** — 26 จุดอยู่ในหน้า "บริษัท AI"
 *    ซึ่งเป็นหน้าหลักของผลิตภัณฑ์ · 12 จุดเป็นสีเดียวกันเป๊ะ (contrast 1.00)
 *    ส่วนหน้าสาธารณะ (/ , /start) ทำไว้ครบพอสมควรแล้ว จึงยังเปิดใช้ได้
 *
 ...
 * เปลี่ยนเป็น true เมื่อ contrast-audit รายงาน 🔴 = 0 (มีเทสต์ themeSafeColor.test.ts เฝ้าเงื่อนไขนี้)
