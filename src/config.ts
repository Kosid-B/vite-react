 ...
 *
 * 🟢 เงื่อนไขที่ตั้งไว้ผ่านแล้ว — วัดจริง 22 ส.ค. 2569 12:44 น.
 *    `npm run dev` + `node scripts/contrast-audit.mjs 4.5` · เดินครบ **50 หน้า** (2 ธีม × 25) · exit code 0
 *    🔴 ข้อความที่ "มองไม่เห็นเลย" (contrast < 2.0) = **0 จุด** (ตอนเริ่มงานคือ 58)
 *
