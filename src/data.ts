...
export const DEFAULT_DATA: AppData = {
  ...
  actions: [
    { done: false, title: 'ทำ Case Study แยก Industry พร้อมตัวเลขจริง', desc: "ลูกค้า SME ไม่เชื่อ testimonial ทั่วไป — ต้องการธุรกิจที่ใกล้เคียงและผลลัพธ์จับต้องได้ เช่น 'ลดต้นทุน 18% ใน 90 วัน สำหรับโรงงานทีม 40 คน'", priority: 1, nb: '#fdf3f0', nt: '#c44b2b', tags: [{ l: 'Impact สูง', c: 't-impact' }, { l: 'Effort ต่ำ', c: 't-effort' }, { l: 'ประเมิน', c: 't-stage' }, { l: 'ตัดสินใจ', c: 't-stage' }] },
    { done: false, title: 'เพิ่ม ROI Calculator บน Proposal', desc: 'ช่วงตัดสินใจคือ pain สูงสุด — proposal ที่มีตัวเลข ROI ชัดเจนช่วยลด friction ได้มาก ลูกค้าต้องเอาไป justify กับหุ้นส่วนและ CFO', priority: 2, nb: '#fdf6ec', nt: '#a05c1a', tags: [{ l: 'Impact สูง', c: 't-impact' }, { l: 'Effort กลาง', c: 't-effort' }, { l: 'ตัดสินใจ', c: 't-stage' }] },
    { done: false, title: "ตั้ง Auto-reply + 'คู่มือเตรียมตัวก่อนนัดคุย'", desc: 'Inbound lead ที่รอ response นานกว่า 4 ชั่วโมงมักเสียความสนใจ ส่ง guide สั้นๆ ทันทีสร้าง trust และช่วยให้ discovery call มีคุณภาพขึ้น', priority: 2, nb: '#fdf6ec', nt: '#a05c1a', tags: [{ l: 'Impact สูง', c: 't-impact' }, { l: 'Effort ต่ำ', c: 't-effort' }, { l: 'ติดต่อ', c: 't-stage' }] },
    { done: false, title: "เพิ่ม 'เช็คลิสต์วินิจฉัยปัญหา' บน Blog", desc: 'ลูกค้า SME ช่วง Trigger ยังไม่แน่ใจว่าต้องการ consultant — tool ง่ายๆ ที่ช่วย self-qualify เพิ่มโอกาสที่เขาจะติดต่อมาพร้อมความตั้งใจสูง', priority: 3, nb: '#f5f0e8', nt: '#4a453e', tags: [{ l: 'Impact กลาง', c: 't-impact' }, { l: 'Effort ต่ำ', c: 't-effort' }, { l: 'ค้นหา', c: 't-stage' }, { l: 'พบเรา', c: 't-stage' }] },
    { done: false, title: 'กำหนด Quick Win 30 วันแรกใน Onboarding', desc: 'ลูกค้าที่เพิ่งเซ็นสัญญาต้องการเห็นผลลัพธ์เร็ว ระบุ deliverable ชิ้นแรกที่จับต้องได้ภายใน 4 สัปดาห์เพื่อรักษา momentum', priority: 3, nb: '#f5f0e8', nt: '#4a453e', tags: [{ l: 'Impact กลาง', c: 't-impact' }, { l: 'Effort กลาง', c: 't-effort' }, { l: 'ดำเนินงาน', c: 't-stage' }] },
    { done: false, title: 'สร้าง Referral Program สำหรับ MD Network', desc: 'ลูกค้าที่พึงพอใจมี referral intent สูง แต่มักไม่ทำเพราะไม่มี mechanism ง่ายๆ incentive เล็กน้อยหรือ co-case study เปิด loop นี้ได้', priority: 3, nb: '#f5f0e8', nt: '#4a453e', tags: [{ l: 'Impact สูง', c: 't-impact' }, { l: 'Effort กลาง', c: 't-effort' }, { l: 'รักษา', c: 't-stage' }] },
  ],
  funnel: [
