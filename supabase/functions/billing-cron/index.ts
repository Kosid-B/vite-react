...
const PRICE: Record<string, number> = { free: 0, starter: 790, growth: 1490, scale: 5900 };
...
function renewalReminderHtml(plan: string, amount: number): string {
  const planLabel = plan === "starter" ? "Starter ฿790/เดือน" : plan === "growth" ? "Growth ฿1,490/เดือน" : plan === "scale" ? "Scale ฿5,900/เดือน" : plan;
  return `
